...
# GET 'employee/count' - returns the total number of employees



def employee_count(employees: List[Employee]) -> float:
    count = len(employees)
    return count
employees = 'C:/Users/Fassil/Downloads/Employees.txt'
employee_count(employees)
# GET 'employee/all' - returns the id and name of all employees
...
def main():
    employees = read_employees('C:/Users/Fassil/Downloads/Employees.txt')
